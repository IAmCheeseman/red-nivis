...
for file in walkDirRec getCurrentDir():
    ...
    if fileSplit.ext != "" and not contains(fileSplit.dir, '.') and (fileSplit.ext == ".gd" or fileSplit.ext == ".tscn" or fileSplit.ext == ".tres"):
        var i = 1
    ...
    if lineCount > longestFileLen:
        longestFile = str
        longestFileLen = lineCount
...
echo ""
echo "longest file: " & longestFile & " with " & $longestFileLen & " lines."
