...
const ROOM_POINTS = 100
const EASY_ENEMY_POINTS = 100
const MEDIUM_ENEMY_POINTS = 250
const HARD_ENEMY_POINTS = 500
const ROOM_BEAT_1M_POINTS = 1300
const ROOM_BEAT_1MH_POINTS = 800
const ROOM_BEAT_POINTS = 400
const BULLT_SKIM_POINTS = 75
